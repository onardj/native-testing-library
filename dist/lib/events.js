...
var eventMap = {
  ...
  Button: ['layout', 'press'],
  DrawerLayoutAndroid: [].concat(viewEvents, [
    'drawerClose',
    'drawerOpen',
    'drawerSlide',
    'drawerStateChanged',
...
function isDisabled(element) {
  var _element$props = element.props,
    _element$props$access = _element$props.accessibilityState,
    accessibilityState = _element$props$access === void 0 ? {} : _element$props$access,
...
var eventList = Object.keys(eventMap).reduce(function(list, name) {
  return [].concat(
    (0, _toConsumableArray2.default)(list),
    (0, _toConsumableArray2.default)(
      eventMap[name].filter(function(event) {
